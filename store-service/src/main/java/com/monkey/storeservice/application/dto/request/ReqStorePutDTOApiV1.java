...
@AllArgsConstructor
@Builder
public class ReqStorePutDTOApiV1 {
  ...
  public static class Store{
    ...
    public void update(StoreEntity storeEntity){
      ...
      storeEntity.setOpenStatus(openStatus);
      storeEntity.setStartDate(startDate);
      storeEntity.setEndDate(endDate);
      storeEntity.setStartTime(startTime);
      storeEntity.setEndTime(endTime);
      storeEntity.setTotalPersonCount(totalPersonCount);
    }
  }
}